...
const CreateSuppliers: React.FC<CreateSuppliersProps> = ({ supplier, onClose, onSubmit }) => {
  const fields = [
    { label: 'Name', key: 'name' },
  ...
  return (
    <PopupBase
      ...
      initialData={supplier || { name: '', description: '', contact_person: '', phone_number: '', address: '', email: '' }}
      fields={fields}
      onClose={onClose}
      onSubmit={onSubmit}
    />
