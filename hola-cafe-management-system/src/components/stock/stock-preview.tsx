...
const StockPreview = ({
    ...
    try {
      ...
      setUpdatedStocks((prevStocks) =>
        prevStocks.map((stock) =>
          stock.id === stockId
            ? { ...stock, quantity: newQuantity.toString() }
            : stock
        )
      );
      if (callback) {
  ...
  const getStockStatus = (quantity: number, isExpired: boolean): string => {
                      ...
                      <div className=" w-full flex flex-col gap-5 justify-start text-wrap">
                        ...
                        <div className="flex flex-col">
                          <p className="text-sm tracking-wide">
                            ...
                            <span className="text-xs underline me-2">
                            ...
                            >
                              {stock.is_expired ? "⚠ Expired" : "Not Expired"}
                            </span>
                          </p>
                        </div>
                        <div className="flex flex-col">
                      ...
                      <div className="flex flex-col">
                        <p className="text-xl font-semibold">
                          {getStockStatus(
                            ...
                            ? "Expired"
                            : `We have ${Number(stock.quantity).toFixed(
                                2
                              )} stocks left`}
                        </p>
                        <span
